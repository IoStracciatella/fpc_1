...
def gerar_tamanhos(start, end, step):
    return np.arange(start, end + 1, step)

# Gera tamanhos de matrizes de ordem 1000 até 5000 com diferenças de 1000 entre cada
sizes = gerar_tamanhos(1000, 5000, 1000)
